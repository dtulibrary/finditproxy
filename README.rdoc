== DADS Primo Proxy
The purpose of the DADS Primo Proxy is to enable Primo installations to search in DTIC's Solr, while transforming search results to PNX format making them understandable for Primo.

== Requirements
In order to use DADS Primo Proxy:
